...
class Board(Canvas):
    ...
    def gameOver(self):
        ...
        self.create_text(self.winfo_width() / 2, self.winfo_height() / 2,
                         text="Game Over \n Score: {0}".format(self.score), fill="white")
    ...
    def loadImages(self):
        ...
        try:
            self.ibody = Image.open("Pictures/reddot.png")
            self.ihead = Image.open("Pictures/bluedot.png")
            self.iapple = Image.open("Pictures/apple.png")
